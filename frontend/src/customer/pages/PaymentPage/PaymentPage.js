...
//             <p id="included-info-heading1">Booking Information</p>
//             <p id="included-info-heading2">Your booking will start on</p>
//             <p >{booking.rental_start_date} </p>
//             <p id="included-info-heading3">And will end on</p>
//             <p >{booking.rental_end_date} </p>
//           </div>

//           <div className="included-info">
//             <p id="included-info-heading1">Upon meeting up</p>
//             <p id="included-info-heading2">Please pay the amount below</p>
//             <p >{booking.total_price} </p>
//           </div>
          
//           <div className="included-info">
//             <p id="included-info-heading1">Pickup and Dropoff</p>
//             <p >Pickup: {booking.pickup_location} at {booking.pickup_time}</p>
//             <p >Dropoff: {booking.dropoff_location} at {booking.dropoff_time} </p>
//           </div>


//           <div className="included-info ">
//             <p id="included-info-heading1">Tips for a smooth ride</p>
