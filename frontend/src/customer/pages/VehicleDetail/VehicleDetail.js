...
const VehicleDetail = () => {
  ...
  if (!vehicle) return  <p>Oops! All motorcycle are currently booked.</p>;

  return (
    <>
      <Header color="white" position="sticky" />

      <div className="view-container">
      <div className="vehicle-detail">
      <Link to="/Motorcycles"><ArrowLeft color="#212529" className="arrow-back" /></Link>
          {/* <img src={vehicle.imageSrc} alt={vehicle.brand} /> */}
          <img
  src={`/images/${vehicle.model}.png`}
  alt={vehicle.model}
  onError={(e) => {
...
/>
          ...
          <p id="productName">{vehicle.brand} {vehicle.model}</p>
