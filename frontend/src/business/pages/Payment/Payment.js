    ...
    return (
      <>
        ...
        <div className="booking-body my-12 mx-auto">
          ...
          <p id="">Please send the amount of <span>999</span> to</p>

       <div className="personal-details my-8">
        <p>Name:  <span className="">Ki* L**uyo</span></p>
        <p>Account Number:  <span className="">09582347697 </span></p>
        <p>Email:<span className="">  Kia@gmail.com</span> </p>
        <img className="h-36"
  src={`/images/qr.png`}
/>
<div className="ref">
<label htmlFor="">Reference No.</label>
<input type="number" id="reference" name="Reference No."  />
</div>
       </div>
